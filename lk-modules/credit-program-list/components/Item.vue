<template>
  <button
    class="bank-prog-item"
    :class="{ 'bank-prog-item--active': isActive }"
    @click="toogleOffer"
  >
...
<script setup lang="ts">
  ...
  const isActive = computed(() => {
    return creditCalc.hasOffer(props.item.id);
  });

  function toogleOffer() {
    creditCalc.toogleOffer(props.item.id);
  }
</script>
