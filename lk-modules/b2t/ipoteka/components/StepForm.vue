...
<script setup lang="ts">
  ...
  import PersonalDataForm from '@/lk-modules/b2t/client-data/components/PersonalDataForm.vue';
  import FinishStep from './FinishStep.vue';
  import { useClientProfile } from '@/lk-modules/b2t/client-data/store/index';
