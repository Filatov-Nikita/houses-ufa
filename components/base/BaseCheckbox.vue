<template>
  <div class="base-checkbox">
    <div class="checkbox" @click="handleChange(checkedValue)">
      <div :class="checkboxClasses" role="checkbox">
        <svg v-show="checked" class="check-mark" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
...
<script setup lang="ts">
  ...
  const checkboxClasses = computed(() => {
    return [
      ...
      'tw-relative',
      {
        'tw-bg-secondary tw-border-border00': !checked?.value,
        'tw-bg-primary tw-border-primary': checked?.value,
      }
    ]
  });
