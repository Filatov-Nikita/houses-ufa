...
const list = [
  ...
  },
  {
    ...
    description: 'Поддерживать чистоту и работоспособность систем безопасности и систем обеспечения в построенных объектах необходимо на постоянной основе, поэтому было принято решение о создании собственной управляющей компании "Комфортный дом". Теперь обеспечение порядка на территории посёлков и жилых комплексов, очистка дорог от снега, благоустройство и, конечно же, техническое обслуживание коммунальных систем общего назначения — под контролем нашей управляющей компании.',
