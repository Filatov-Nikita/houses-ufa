...
const list = [
  ...
  {
    year: '2015',
    title: 'Начало строительства ЖК «Михайловка зеленая»',
    description: '«Михайловка зеленая» - наш первый проект комплексного освоения территории. Такой формат позволяет строить не просто дома, а самодостаточные кварталы, комфортные для жизни, работы и проведения досуга, ведь вместе с жильём возводится и вся необходимая инфраструктура. Начав строительство в чистом поле, мы протянули инженерные сети, построили автомобильные дороги и пешеходные тротуары, обеспечили безопасность, установив освещение и видеонаблюдение на территории. На сегодняшний день, по проекту уже построены и заселены 20 домов, современный учебный центр на базе которого размещены школа и детский сад, открыт медицинский центр, работают магазины крупных федеральных сетей, пункты выдачи интернет заказов и многое другое.',
    img: '/images/history/2015.png',
  },
  {
    year: '2016',
    title: 'Начало работы собственной управляющей компании.',
    description: 'Поддерживать чистоту и работоспособность систем "Комфортный дом" и систем обеспечения в построенных объектах необходимо на постоянной основе, поэтому было принято решение о создании собственной управляющей компании. Теперь обеспечение порядка на территории посёлков и жилых комплексов, очистка дорог от снега, благоустройство и, конечно же, техническое обслуживание коммунальных систем общего назначения — под контролем нашей управляющей компании.',
  ...
  {
    year: '2024',
    title: 'Вывод на рынок новой линейки домов с расширенными характеристиками комфорта в ЖК «Зубово Лайф Гарден».',
    description: 'Накопив большой опыт эксплуатации жилых комплексов, ГК «Жилой Квартал» сделала следующий шаг. Выведя на рынок новую линейку домов с эргономичными планировками, дворами без машин, благоустройством территории: детские и спортивные площадки, зоны отдыха. Так жители получают и комфортное жильё, и безопасное общественное пространство в шаговой доступности.',
    img: '/images/history/2024.jpg',
  },
  {
    year: '2025',
    title: 'Вывод на рынок нового формата жилья: особый квартал «Ника».',
    description: 'На рынке Уфы появился запрос на гибридный формат жилья: без соседей сверху и без хлопот по обслуживанию индивидуального дома. Поэтому компания спроектировала и вывела на рынок особый квартал «Ника»: дома на 8 квартир, каждая из которых является двухуровневой и имеет выход на общий задний двор. Закрытая территория двора позволяет не беспокоиться за детей на прогулке, здесь у каждого есть свое парковочное место. А за порядком на территории и за обслуживанием коммуникаций следит управляющая компания. Идеальный гибрид таунхауса и квартиры.',
    img: '/images/history/2025.jpg',
  },
]
