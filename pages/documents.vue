    ...
    <div class="wrapper">
      <ul class="doc-list">
        <li
          ...
          v-for="doc in data"
        >
          <a class="doc-list__link" :href="doc.href" download>{{ doc.label }}</a>
        </li>
      </ul>
    </div>
  </section>
...
<script setup lang="ts">
  ...
  const data = [
    {
      label: '«Положение об антикоррупционной политике ООО Специализированный застройщик «МКД-Регион»',
      href: '/docs/Положение_об_антикоррупционной_политике_ООО_Специализированный_застройщик_МКД_Регион.pdf',
    },
    {
      label: '«Положение об антикоррупционной политике Специализированный застройщик  ООО «Паритет»',
      href: '/docs/Положение_об_антикоррупционной_политике_Специализированный_застройщик_ООО_Паритет.pdf',
    },
    {
      label: 'Регламент «Требования охраны труда, пожарной и промышленной безопасности, предъявляемые к подрядным организациям для предотвращения производственных рисков при выполнении строительно-монтажных работ на объектах ООО «Дом Строй» от 02.05.2024 года.',
      href: '/docs/Регламент_Требования_охраны_труда,_пожарной_и_промышленной_безопасности_дом_строй.pdf',
    },
    {
      label: 'Регламент «Требования охраны труда, пожарной  и промышленной безопасности, предъявляемые к подрядным организациям для предотвращения производственных рисков при выполнении строительно-монтажных работ на объектах ООО «Стройнадзор» от 01.06.2024 года.',
      href: '/docs/Регламент_Требования_охраны_труда,_пожарной_и_промышленной_безопасности_стройнадзор.pdf',
    },
    {
      label: 'Положение об антикоррупционной политике ООО СЗ Аспект от 22.09.25',
      href: '/docs/Положение_об_антикор_политике_ООО_СЗ_Аспект_от_22.09.25.pdf',
    },
  ];
</script>
