...
export const useTownProgress = defineStore('complexProgress', () => {
  ...
  const cameraUrl = computed(() => `estate/towns/${townId.value}/overwatches`);
  ...
  const albumUrl = computed(() => `estate/towns/${townId.value}/build-feeds`);
